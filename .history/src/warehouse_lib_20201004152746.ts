...
export function getNeighbours(
    ...
    // TODO: Redo this to not have a time complexity of O(n²)
    return [...nodePosMap]
        .filter(
            ([id, pos]) =>
 ...
 * @remark the main difference between the two is that {@link NodeGraph} Nodes are aware of their neighbours  
 * @param nodePositions 
 */
